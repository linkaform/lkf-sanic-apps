...
class Base(base.LKF_Base):
    ...
    def __init__(self, settings, folio_solicitud=None, sys_argv=None, use_api=False, **kwargs):
        ...
        # self.user_id ya es una property heredada de LKF_Base (resuelta por
        # request via contextvars en Sanic, o via sys_argv en scripts
        # standalone) -- no hace falta congelarla aqui en el __init__.
    ...
    def load(self, module , module_class=None, import_as=None, **kwargs):
        ...
        if hasattr(self, import_as):
            ...
            # imp_module = importlib.import_module(f'lkf_addons.{module.lower()}.app')
            print('module', module)
            # from lkf_addons.employee import app
            imp_module = importlib.import_module(f'lkf_addons.{module.lower()}.app')
